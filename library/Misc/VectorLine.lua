...
---@field loop bool If true, the end point is connected to the start point. *Optional, defaults to false*
---@field square bool If true, line ends aren't rounded. *Optional, default to false*
